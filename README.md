Nội dung của hướng dẫn lệnh git cơ bản:
1. "git add ." lệnh này mục tiêu thêm vào sau khi mình chạy code trên màn hình
2. 'git commit -m "<hãy nhập bình luận>"': mục đích để comment người đọc và team
